...
namespace Lab10.Hash
{
    public class SHA1
    {
        ...
        public static dynamic Hash(string message, bool asString = true)
        {
            ResetHash();
            ...
            string stringHash = $"{H0:x8}{H1:x8}{H2:x8}{H3:x8}{H4:x8}";
            BigInteger numberHash = new(H0);
            numberHash = (numberHash << 32) | H1;
            numberHash = (numberHash << 32) | H2;
            numberHash = (numberHash << 32) | H3;
            numberHash = (numberHash << 32) | H4;

            ResetHash();

            return asString ? stringHash : numberHash;
        }
