...
namespace Lab10.ExtensionMethods
{
    public static class Int64Extension
    {
        ...
        public static long PrimeDivider(this long value)
        {
            if (value.IsPrime())
            {
                return value;
        ...
        public static long GetRootOfPow(this long value, long module)
        {
            for (long i = 2; i < module; i++)
            {
                if (BigInteger.ModPow(i, value, module) == 1)
                {
                    return i;
                }
            }
